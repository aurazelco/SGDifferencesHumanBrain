...
main <- "UCSC/outputs/DEGs_adjust_pval/"

dir.create(main, recursive = T, showWarnings = F)

trim_2nd <- readRDS("UCSC/Seurat_UCSC/Velmeshev/Velmeshev_2022_2nd_trimester.rds")
...
main_local <- "UCSC/DEGs_adjust_pval/Velmeshev_2022_2nd_trimester/outputs/"
...
all_genes <- read.csv("UCSC/DEGs_adjust_pval/Velmeshev_2022_2nd_trimester/tot_genes_ct_Velmeshev_2022_2nd_trimester.csv")
all_genes$X <- NULL
