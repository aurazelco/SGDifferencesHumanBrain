...
main <- "/Home/ii/auraz/data/UCSC/outputs/DEGs_adjust_pval/"
...
main_local <- "/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/UCSC/DEGs_adjust_pval/Velmeshev_2022_2nd_trimester/outputs/"
...
PlotGeneralHeatmap(main_local, chr_2nd_trim, ct_order, "Velmeshev_2nd_trimester")
...
all_genes <- read.csv("/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/UCSC/DEGs_adjust_pval/Velmeshev_2022_2nd_trimester/tot_genes_ct_Velmeshev_2022_2nd_trimester.csv")
all_genes$X <- NULL
