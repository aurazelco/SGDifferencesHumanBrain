...
####### GENERAL VARIABLES
main_local <- "UCSC/DEGs_adjust_pval/Velmeshev_2022_0_1_years/outputs/"
...
all_genes <- read.csv("UCSC/DEGs_adjust_pval/Velmeshev_2022_0_1_years/tot_genes_ct_Velmeshev_2022_0_1_years.csv")
all_genes$X <- NULL
