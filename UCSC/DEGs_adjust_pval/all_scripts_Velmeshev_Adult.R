...
adults <- readRDS("/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/UCSC/Seurat_UCSC/Velmeshev_2022_Adult.rds")
#adults@meta.data$sex_ct <- paste(adults@meta.data$sex, adults@meta.data$cluster_final, sep="_")
Idents(adults) <- "sex_ct"

min_cells <- 100

main_deg <- paste0(main, "Velmeshev_2022_Adult/outputs/")
...
####### GENERAL VARIABLES
main_local <- "/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/UCSC/DEGs_adjust_pval/Velmeshev_2022_Adult/outputs/"
...
ExtractSharedGenes(main_local, chr_adults)
PlotGeneralHeatmap(main_local, chr_adults, ct_order, "Velmeshev_Adults")
...
all_genes <- read.csv("/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/UCSC/DEGs_adjust_pval/Velmeshev_2022_Adult/tot_genes_ct_Velmeshev_2022_Adult.csv")
all_genes$X <- NULL
