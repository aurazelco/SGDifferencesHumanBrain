...
adults <- readRDS("UCSC/Seurat_UCSC/Velmeshev_2022_Adult.rds")
...
####### GENERAL VARIABLES
main_local <- "UCSC/DEGs_adjust_pval/Velmeshev_2022_Adult/outputs/"
...
all_genes <- read.csv("UCSC/DEGs_adjust_pval/Velmeshev_2022_Adult/tot_genes_ct_Velmeshev_2022_Adult.csv")
all_genes$X <- NULL
