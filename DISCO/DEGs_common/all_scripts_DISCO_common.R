...
main <- "/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs_common/outputs/"
...
for (disease_type in unique(final_groups$disease)) {
  ...
  for (ct_type in unique(final_filt_disease$ct)) {
    if ((disease_type!="Multiple Sclerosis") & (length(unique(final_filt_disease[which(final_filt_disease$ct==ct_type), "proj"])) > 1)) {
      ...
      print(paste(disease_type, ct_type, "has only one project with >", min_cells, "cells when there should be at least 2"))
    }
  }
}
...
source("/Users/aurazelco/Desktop/Lund_MSc/Thesis/scripts/DISCO/DEGs_common/01B_plot_num_genes_func.R")
...
# AD
num_df_AD <- IntersectDEG(main, sub_disease[1], pval_thresh, FC_thresh, ct_order)
...
source("/Users/aurazelco/Desktop/Lund_MSc/Thesis/scripts/DISCO/DEGs_common/01C_num_chr_func.R")
...
source("/Users/aurazelco/Desktop/Lund_MSc/Thesis/scripts/DISCO/DEGs_common/01D_Xpar1,2_func.R")

Xpar1 <- read.csv("/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs_common/extra_files/Xpar1.csv",
                  skip = 1)
Xpar1_list <- Xpar1$Approved.symbol
Xpar2 <- read.csv("/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs_common/extra_files/Xpar2.csv",
                  skip = 1)
...
source("/Users/aurazelco/Desktop/Lund_MSc/Thesis/scripts/DISCO/DEGs_common/01E_CellMarker_func.R")
...
extra_path <- "/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs_common/extra_files/"
...
source("/Users/aurazelco/Desktop/Lund_MSc/Thesis/scripts/DISCO/DEGs_common/01C_num_chr_func.R")
source("/Users/aurazelco/Desktop/Lund_MSc/Thesis/scripts/DISCO/DEGs_common/02A_Fisher_func.R")
...
source("/Users/aurazelco/Desktop/Lund_MSc/Thesis/scripts/DISCO/DEGs_common/02B_ARE_ERE_func.R")

ARE <- read_excel("Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs_common/extra_files/AREsitesHuman.xlsx",
                  skip=1)
colnames(ARE) <- c("fullsites", "halfsites")

ERE <- read_excel("Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs_common/extra_files/Hs_allEREs.xls")
...
source("/Users/aurazelco/Desktop/Lund_MSc/Thesis/scripts/DISCO/DEGs_common/02C_Conservation_func.R")

# CONSERVATION ACROSS PRIMATES
conserved <- read.csv("/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs_common/extra_files/mart_export.txt",
                      sep = '\t',
                      header = TRUE,
                      fill = TRUE)
...
all_genes <- read.csv("/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs_common/tot_genes_ct.csv")
all_genes$X <- NULL
