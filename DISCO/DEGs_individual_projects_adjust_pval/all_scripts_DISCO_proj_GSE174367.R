...
PlotGeneralHeatmap(main, sub_disease[2], chr_normal, ct_order, "Healthy_GSE174367")
...
PlotGeneralHeatmap(main, sub_disease[1], chr_ad, ct_order, "Alzheimer's disease_GSE174367")
