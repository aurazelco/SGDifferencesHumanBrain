...
for (min_cells in min_num_cells) {
  ...
  final_groups$ct <- factor(final_groups$ct, levels=c(
    "L2/3 EN",               
    "L4 EN",   
    "PLCH1 L4/5 EN", 
    "TSHZ2 L4/5 EN", 
  ...
  for (dis_type in levels(final_groups$disease)) {
  ...
  for (dis_type in sub_disease) {
    filt_df <- subset(final_groups, disease == dis_type)
    pdf(paste0(main, dis_type, "/num_ct_sex_proj_", min_cells,  "_cells_min.pdf"))
    print(
...
Xpar1 <- read.csv("/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs/extra_files/Xpar1.csv",
                  skip = 1)
Xpar1_list <- Xpar1$Approved.symbol
Xpar2 <- read.csv("/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs/extra_files/Xpar2.csv",
                  skip = 1)
...
extra_path <- "/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs/extra_files/"
...
ARE <- read_excel("Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs/extra_files/AREsitesHuman.xlsx",
                  skip=1)
colnames(ARE) <- c("fullsites", "halfsites")

ERE <- read_excel("Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs/extra_files/Hs_allEREs.xls")
...
#SAGD <- read.csv("/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs/extra_files/Sexassociatedgene_Padj0.05_PMID30380119.csv")
#SAGD <- SAGD[, c(2,4)]
...
#write.csv(SAGD_df, "/Users/aurazelco/Desktop/Lund_MSc/Thesis/data/DISCOv1.0/DEGs/extra_files/SAGD_filt.csv")
